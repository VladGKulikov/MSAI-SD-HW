...
# Result:
# Ok. The user swarm is registered in messenger wapp
# Ok. User swarm added in chat_MIPT_SD
# Ok. User swarm added in chat_MIPT_MO
# Ok. The user tramp is registered in messenger wapp
# Ok. User tramp added in chat_MIPT_SD
# Ok. User tramp added in chat_MIPT_ML
# Ok. Message Yes added to chat chat_MIPT_SD
# Ok. Message Yes added to chat chat_MIPT_SD
# ERROR - User tramp not in chat chat_MIPT_MO
# Ok. Message Yes added to chat chat_MIPT_SD
# Word: Yes is found in messenger wapp - 3 times
# Shared_chats:
# chat_MIPT_SD
# Ok. The user tank is registered in messenger tel

# Messengers not equal
# Messengers is equal

# {'+79149462682', '+79149453676'}
# {'swarm@gmail.com', 'tramp@gmail.com'}
# {'+79149453676'}
# {'tramp@gmail.com'}
# {'+79149462682'}
# {'swarm@gmail.com'}
...
# YES  - Are all methods that do not refer to class fields declared static? 
# @staticmethod
#     def compare_messengers(obj1, obj2):
# ...
#    @staticmethod
...
# YES.  - Which class members are better to be private or protected? Pay attention of the PR author to the need to use `@property`, where appropriate.
# In class User:, class Message:, class Chat:, 
